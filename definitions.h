...
#define STEP_RATE_IN_MILLISECONDS 800 // Default drop speed, one drop every 300 ms
#define BLOCK_SIZE_IN_PIXELS 24

#define GAME_WIDTH 24U
#define GAME_HEIGHT 24U
...
// All the tetris shapes (represented in x, y coordinates)
#define N_SHAPES 7;
...
// Tetris grid, 10 by 20 grid with RGB values to keep track of the colors as the board fills up and the fourth value of 0 or 1 to keep track of tetris piece
typedef struct {
    int grid[10][20][4];
    int score;
    int currentHold;
